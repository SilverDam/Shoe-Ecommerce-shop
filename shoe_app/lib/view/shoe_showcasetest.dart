...
class ShoeShowCasetest extends StatefulWidget {
  final int index;

  const ShoeShowCasetest(this.index, {Key? key}) : super(key: key);

  @override
  State<ShoeShowCasetest> createState() => _ShoeShowCasetestState();
}

class _ShoeShowCasetestState extends State<ShoeShowCasetest>
  ...
  void initState() {
    ...
    _colorcurve =
        CurvedAnimation(parent: _iconcontroller, curve: Curves.slowMiddle);
      ...
      builder: (BuildContext context, _) {
        return Transform.rotate(
            ...
            child: SimpleShadow(
                ...
                sigma: 10,
                child: shoeModel[widget.index].name == "Nike Air Force 1"
                    ? nikeAirForce[index] == 0
                        ? Hero(
                            tag: '${shoeModel[widget.index].name}}',
                            child: Image(
                              image: AssetImage(nikeAirForce[index].img),
                            ))
                        : Image(image: AssetImage(nikeAirForce[index].img))
                    : shoeModel[widget.index].name == "Nike Air Max 90"
                        ? nikeAirMax90[index] == 0
                            ? Hero(
                                tag: '${shoeModel[widget.index].name}}',
                                child: Image(
                                  image: AssetImage(nikeAirMax90[index].img),
                                ))
                            : Image(image: AssetImage(nikeAirMax90[index].img))
                        : shoeModel[widget.index].name == "Nike Air Max 97"
                            ? nikeAirMax97[index] == 0
                                ? Hero(
                                    tag: '${shoeModel[widget.index].name}}',
                                    child: Image(
                                      image:
                                ...
                                : Image(
                                    image: AssetImage(nikeAirMax97[index].img))
                            : shoeModel[widget.index].name ==
                                    "Nike Air Vapormax 2021 FK"
                                ? nikeAirMaxVapor2021Fk[index] == 0
                                    ? Hero(
                                        tag: '${shoeModel[widget.index].name}}',
                                        child: Image(
                                          image: AssetImage(
                                ...
                                : shoeModel[widget.index].name ==
                                        "Nike Air Vapormax Plus1"
                                    ? nikeAirMaxVaporPlus[index] == 0
                                        ? Hero(
                                            tag:
                                                '${shoeModel[widget.index].name}}',
                                            child: Image(
                                              image: AssetImage(
                                                  nikeAirMaxVaporPlus[index]
                                                      .img),
                                            ))
                                        : Image(
                                            image: AssetImage(
